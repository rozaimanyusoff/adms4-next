...
const TelcoReportControls: React.FC<{ onExport: (params: any) => void }> = ({ onExport }) => {
    ...
    return (
        <div className='mt-8'>
           ...
           <div className="grid grid-cols-1 md:grid-cols-7 gap-2 items-center my-4">
            ...
            <Select value={accountId} onValueChange={setAccountId} disabled={category !== 'Account'}>
                <SelectTrigger className='w-full'>
            ...
            <Select value={costCenterId} onValueChange={setCostCenterId} disabled={category !== 'Cost Center'}>
                <SelectTrigger className='w-full'>
                    <SelectValue placeholder="Select Cost Center.." />
                </SelectTrigger>
                <SelectContent>
                    <SelectGroup>
                        <SelectLabel>Cost Center</SelectLabel>
                        {costCenters.map(cc => (
...
export default TelcoReportControls;
