                    ...
                    <fieldset className="border rounded p-4">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                            ...
                            {backdated ? (
                                <>
                                    <div>
                                        <label className="block font-medium mb-1">Manual PR No</label>
                                        <Input type="text" name="manual_pr_no" value={manualPrNo} onChange={e => setManualPrNo(e.target.value)} />
                                    </div>
                                    <div>
                            ...
                            <Button
                                ...
                                onClick={() => {
                                    if (!form.request_type) {
                                        ...
                                        // Optionally scroll to the radio group
                                    ...
                                    <div key={item.id} className="border rounded p-3 bg-slate-50 dark:bg-gray-800 space-y-4">
                                        ...
                                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                            ...
                                            <div>
                                                ...
                                                <Textarea placeholder='Justify your purposes..' value={item.justification} onChange={e => setItems(prev => prev.map((itm, i) => i === idx ? { ...itm, justification: e.target.value } : itm))} />
                                            </div>
                                        </div>
                                        ...
                                        {backdated && Number(item.quantity) > 0 && (
                                            <>
                                                ...
                                                <div className="mt-1 text-blue-700 text-xs font-medium">
                                                    Register Number fields only appear for backdated purchase registration. Please enter the register number(s) for each item.
                                                </div>
                                            </>
                                        )}
                                    </div>
