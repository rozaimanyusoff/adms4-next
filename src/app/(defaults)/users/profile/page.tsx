...
const Profile = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            toast.success((res.data as any)?.message || 'Your profile was updated successfully.');
    ...
    const handleAddTask = async (e: React.FormEvent) => {
        ...
        try {
            ...
            setNewTask('');
            fetchTasks();
            toast.success((res.data as any)?.message || 'Task added successfully.');
        } catch (err: any) {
    ...
    const handleUpdateTask = async (e: React.FormEvent) => {
        ...
        try {
            ...
            setEditProgress(0);
            fetchTasks();
            toast.success((res.data as any)?.message || 'Task updated successfully.');
        } catch (err: any) {
    ...
    const handleToggleTask = async (id: number) => {
        ...
        try {
            ...
            fetchTasks();
            toast.success((res.data as any)?.message || 'Task status updated.');
        } catch (err: any) {
            toast.error(err?.response?.data?.message || 'Failed to update task');
        }
    };
